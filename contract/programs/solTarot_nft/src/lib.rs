...
use mpl_token_metadata::types::{Creator, DataV2}; // NFT 메타데이터 구조체

declare_id!("7eDZ3HhU6Gg1hDdVrnS3V98oHN4fWCfGEnum7FxXjoVK");
...
pub mod contracts {
    ...
    pub fn mint_tarot_nft(
        ...
        mint_to(
            CpiContext::new(
                //Cross-Program Invocation 컨텍스트 생성
        ...
        let data_v2 = DataV2 {
            ...
            uri: format!("https://violet-tropical-python-392.mypinata.cloud/ipfs/{}", metadata_cid), //json 메타데이터 URI
        ...
        msg!("타로 NFT 민팅 완료!");
        msg!("타로 메타데이터 {}", tarot_reading.metadata_cid);
